...
function displayPics(){
  ...
  // because  rando is a local variable and  we use it outside of its scope. in this case, the code block of the "while" statement created the scope, not the function.
  console.log(viewed);
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = `${ allProducts[i].name} has  ${allProducts[i].votes} votes in  votes in  ${ allProducts[i].views} views`;
